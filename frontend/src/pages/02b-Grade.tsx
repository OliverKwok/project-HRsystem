...
export default function Grade() {
 ...
 let data = [
    ...
    const headerTemplate = (data: any) => {
        return (
            <React.Fragment>
                <img alt={data.representative.name} src={`images/avatar/${data.representative.image}`} 
    ...
    const footerTemplate = (data: any) => {
        return (
            <React.Fragment>
                <td 
                // colSpan='4' 
                style={{ textAlign: 'right' }}>Total Customers</td>
    ...
    const countryBodyTemplate = (rowData: any) => {
        return (
            <React.Fragment>
                <img alt={rowData.country.name} src="/images/flag/flag_placeholder.png" 
                // onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} 
    ...
    const onRowGroupExpand = (event: any) => {
        ((toast.current) as any).show({ severity: 'info', summary: 'Row Group Expanded', detail: 'Value: ' + event.data.representative.name, life: 3000 });
    }

    const onRowGroupCollapse = (event: any) => {
         ((toast.current) as any).show({ severity: 'success', summary: 'Row Group Collapsed', detail: 'Value: ' + event.data.representative.name, life: 3000 });
    }
        ...
        <div className="datatable-rowgroup-demo">
            ...
            <div className="card">
                ...
                <DataTable value={customers} rowGroupMode="subheader" groupRowsBy="representative.name"
                    ...
                    expandableRowGroups expandedRows={expandedRows} onRowToggle={(e: any) => setExpandedRows(e.data)}
